      ...
      <div>
        ...
        <div className="bg-teal-800 rounded-2xl lg:m-14 lg:py-8 p-6 m-6">
          ...
          <div className="w-11/12 mx-auto gap-5 grid grid-cols-1 lg:grid-cols-3 py-5 lg:py-12 md:grid-cols-2">
            ...
            <div className="bg-white max-h-[1200px] mx-auto  hover:bg-yellow-300 rounded-2xl p-5 ">
              ...
              <p className="text-gray-700 text-center">
                “We deliver parcels within 24=-72 hours across major Indian
                cities including Kolkata, Delhi, Mumbai, Chennai, Bengaluru, and
        ...
        <div className="">
          ...
          <section className="max-w-5xl mx-auto px-6 space-y-5  py-12">
            ...
            <div className="w-full border-t-2 border-dashed border-gray-300 mt-8"></div>
          </section>
        </div>
      </div>
    </div>
